...
vector<m68kmapping> funcmappings =
{
    ...
    instruction(0xFFFF, 0x4E73, rte, rte), // 6-84 (p538)
    ...
    instruction(0xFFF8, 0x4E58, unlk, unlk), // 4-194 (p298)
    ...
    instruction(0xF1C0, 0x81C0, divs, divs), // 4-93 (p197)
    ...
    instruction(0xF1F8, 0xB108, cmpm<Byte>, cmpm<Byte>), // 4-81 (p185)
    instruction(0xF1F8, 0xB148, cmpm<Word>, cmpm<Word>), // 4-81 (p185)
    instruction(0xF1F8, 0xB188, cmpm<Long>, cmpm<Long>), // 4-81 (p185)
    ...
    instruction(0xF1C0, 0xC1C0, muls, muls), // 4-136 (p240)

    instruction(0xF1F0, 0xC100, abcd, abcd), // 4-3 (p107)

    instruction(0xF1F8, 0xC140, exgdreg, exgdreg), // 4-105 (p209)
    instruction(0xF1F8, 0xC148, exgareg, exgareg), // 4-105 (p209)
    instruction(0xF1F8, 0xC188, exgdareg, exgdareg), // 4-105 (p209)
    ...
    instruction(0xFFC0, 0xE1C0, asl_mem, asl_mem), // 4-22 (p126)
    ...
    instruction(0xFFC0, 0xE0C0, asr_mem, asr_mem), // 4-22 (p126)
    ...
    instruction(0xFFC0, 0xE3C0, lsl_mem, lsl_mem), // 4-113 (p217)
    ...
    instruction(0xFFC0, 0xE2C0, lsr_mem, lsr_mem), // 4-113 (p217)

    instruction(0xF1D8, 0xE118, rol<Byte>, rol<Byte>), // 4-160 (p264)
    instruction(0xF1D8, 0xE158, rol<Word>, rol<Word>), // 4-160 (p264)
    instruction(0xF1D8, 0xE198, rol<Long>, rol<Long>), // 4-160 (p264)
    instruction(0xFFC0, 0xE7C0, rol_mem, rol_mem), // 4-160 (p264)

    instruction(0xF1D8, 0xE018, ror<Byte>, ror<Byte>), // 4-160 (p264)
    instruction(0xF1D8, 0xE058, ror<Word>, ror<Word>), // 4-160 (p264)
    instruction(0xF1D8, 0xE098, ror<Long>, ror<Long>), // 4-160 (p264)
    instruction(0xFFC0, 0xE6C0, ror_mem, ror_mem), // 4-160 (p264)

    instruction(0xF1D8, 0xE110, roxl<Byte>, roxl<Byte>), // 4-163 (p267)
    instruction(0xF1D8, 0xE150, roxl<Word>, roxl<Word>), // 4-163 (p267)
    instruction(0xF1D8, 0xE190, roxl<Long>, roxl<Long>), // 4-163 (p267)
    instruction(0xFFC0, 0xE5C0, roxl_mem, roxl_mem), // 4-163 (p267)

    instruction(0xF1D8, 0xE010, roxr<Byte>, roxr<Byte>), // 4-163 (p267)
    instruction(0xF1D8, 0xE050, roxr<Word>, roxr<Word>), // 4-163 (p267)
    instruction(0xF1D8, 0xE090, roxr<Long>, roxr<Long>), // 4-163 (p267)
    instruction(0xFFC0, 0xE4C0, roxr_mem, roxr_mem), // 4-163 (p267)
